...
export class Projects implements OnInit {
  ...
  projects = [
    ...
    // }
    {
      title: 'Email Generation App (MailCraft)',
      description: 'AI-powered email generator using Google Gemini API for composing, replying, and formalizing emails with multi-language support.',
      fullDescription: 'MailCraft is a comprehensive email generation platform powered by Google Gemini AI. It enables users to compose new emails, generate intelligent replies, and formalize informal content with support for multiple languages, tones, and complexity levels.',
      iconClass: 'fas fa-envelope',
      gradient: 'linear-gradient(135deg, #667eea 0%, #764ba2 100%)',
      category: 'web-app',
      status: 'completed',
      liveUrl: 'https://mailcraft.prathameshbhanse.live/',
      githubUrl: 'https://github.com/prathamesh-ab/mailcraft', // Update with your actual GitHub repo
      features: [
      ...
      technologies: ['Angular 20', 'ASP.NET Core', 'Google Gemini API', 'TypeScript', 'RxJS', 'CSS3'],
      mainTech: [
        { icon: 'fab fa-angular', color: '#dd0031', gradient: 'linear-gradient(135deg, #dd0031, #c3002f)', name: 'Angular' },
        { icon: 'fab fa-microsoft', color: '#512bd4', gradient: 'linear-gradient(135deg, #512bd4, #3c1a8b)', name: 'ASP.NET' },
        { icon: 'fas fa-robot', color: '#4285f4', gradient: 'linear-gradient(135deg, #4285f4, #34a853)', name: 'Gemini AI' }
      ],
      technicalDetails: [
        {
          title: 'Google Gemini Integration',
          description: 'Integrated Google Gemini 2.0 Flash model for intelligent email generation with custom prompt engineering for different action types (compose, reply, formalize).'
        },
        {
          title: 'Reactive Forms & Validation',
          description: 'Implemented Angular reactive forms with dynamic validation based on action types, character counting, and real-time form state management.'
        },
        {
          title: 'Modern UI/UX Design',
          description: 'Created responsive glassmorphism design with CSS gradients, animations, and toast notifications for enhanced user experience.'
        },
        {
          title: 'Error Handling & Retry Logic',
          description: 'Comprehensive error handling with HTTP interceptors, retry mechanisms, and user-friendly error messages for API failures.'
        }
      ],
      challenges: [
        {
          challenge: 'API Response Consistency',
          solution: 'Implemented custom response parsing and cleaning to ensure consistent email output format from Gemini API across different prompts and languages.'
        },
        {
          challenge: 'Dynamic Form Validation',
          solution: 'Created dynamic validator system that changes validation rules based on selected action type (compose requires subject, reply/formalize require email content).'
        },
        {
          challenge: 'Cross-browser Compatibility',
          solution: 'Implemented fallback clipboard functionality and extensive CSS compatibility fixes for consistent experience across all browsers and devices.'
        }
      ]
    }
    // {
